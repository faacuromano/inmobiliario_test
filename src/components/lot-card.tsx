...
export function LotCard({
  ...
  return (
    <motion.div
      ...
      className={clsx(
        "glass rounded-2xl relative overflow-hidden w-full mx-auto flex flex-col",
        isEmbed ? "h-full max-h-screen p-4" : "p-6 sm:p-8 max-w-md"
      )}
    >
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar space-y-4">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <h2 className={clsx("font-bold font-heading text-dark-green", isEmbed ? "text-3xl" : "text-4xl")}>
              {number}
            </h2>
          </div>
        ...
        <div className="space-y-3">
          {status === "AVAILABLE" && (
            <div>
              ...
              <div className={clsx("font-bold font-heading text-forest", isEmbed ? "text-2xl" : "text-3xl")}>
      ...
      {/* Footer / CTA - Fixed at bottom if needed, or part of flow */}
      {status === "AVAILABLE" && (
